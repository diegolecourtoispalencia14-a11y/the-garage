// src/data/accessories_future.ts
// Catálogo de accesorios, componentes y equipamiento para subir gradualmente
import type { ProductItem } from "./allProducts";

export const FUTURE_ACCESSORIES: ProductItem[] = [
