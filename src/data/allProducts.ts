...
export const MASTER_PRODUCTS: ProductItem[] = [
  ...
  },
  {
    ...
    estado: "Seminueva",
    disciplina: "urbano",
    specs: "Cuadro de aluminio A1 Premium, frenos de disco hidráulicos Promax, transmisión Shimano 3x8 vel, llantas 700x38C mixtas.",
    fotos: [
  ...
  },
  {
    ...
    estado: "Seminueva",
    disciplina: "ruta",
    specs: "Cuadro de aluminio ALUXX y tijera de carbón, transmisión Shimano Claris 2x8 vel, rines doble pared Giant S-R2.",
    fotos: [
  ...
  },
  {
    ...
    stock: 1,
    talla: "S (Mujer)",
    color: "Negro y Azul Aqua con Morado",
    estado: "Seminueva",
    disciplina: "ruta",
    specs: "Geometría femenina Liv 3F, cuadro aluminio ligero con tijera de carbón, grupo Shimano Sora/Claris 2x8 vel, rines 700c.",
    fotos: [
  ...
  },
  {
    ...
    stock: 1,
    talla: "S",
    color: "Verde Oliva / Sage Green",
    estado: "Seminueva",
    disciplina: "mtb",
    specs: "Doble suspensión de aire FlexPoint 120mm, transmisión SRAM SX Eagle 1x12 vel, frenos hidráulicos Shimano MT200, dropper post integrado.",
    fotos: [
  ...
  },
  {
    ...
    estado: "Seminueva",
    disciplina: "mtb",
    specs: "Cuadro de carbono OCLV Mountain, doble suspensión Fox/RockShox de aire con bloqueo remoto, transmisión SRAM GX Eagle 1x12 vel, frenos Shimano Deore hidráulicos.",
    fotos: [
